...
def run_etl():
    ...
    # Get topics from topic.txt
    topics = []
    with open('./twitter/topic_dev.txt') as f:
    ...
    for topic in topics:
        ...
        # Iteration to retrieve next 100 tweets (loop maximum of 100 times to achieve 10,000 tweets goal)
        for _ in range(100):
